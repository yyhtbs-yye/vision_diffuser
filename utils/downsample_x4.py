...
def main():
    ...
    parser.add_argument('--input_dir', type=str, default="./data/celeba/subsets/celeba_1024", help='Directory containing images to downsample.')
    parser.add_argument('--output_dir', type=str, default="./data/celeba/subsets/celeba_16", help='Directory to save downsampled images.')
    parser.add_argument('--scale', type=float, default=0.015625, help='Scale factor for downsampling (0 < scale < 1).')
