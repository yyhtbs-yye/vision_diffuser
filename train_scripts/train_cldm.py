...
from vision.models.generation.conditioned_latent_diffusing import ConditionedLatentDiffusionModel
...
if checkpoint_path and os.path.exists(checkpoint_path):
    ...
    model = ConditionedLatentDiffusionModel.load_from_checkpoint(
        checkpoint_path, 
    ...
    model = ConditionedLatentDiffusionModel(
        model_config=model_config,
        train_config=train_config,
        validation_config=validation_config
    )
